...
export const clientEnvSchema = z.object({
  ...
  NEXT_PUBLIC_WEBCONTAINER_API_KEY: z.string().min(1).optional(),
  NEXT_PUBLIC_WEBCONTAINER_RUNTIME_ORIGIN: z.url().optional(),
...
export const clientProcessEnv: ClientInput = {
  ...
  NEXT_PUBLIC_WEBCONTAINER_API_KEY:
    process.env.NEXT_PUBLIC_WEBCONTAINER_API_KEY,
